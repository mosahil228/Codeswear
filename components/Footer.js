...
const Footer = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    ...
    <Link href={"/"}>
      ...
      <p className="mt-1 text-sm text-gray-500">Premium coding tshirts, hoodies and apparals</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <Link href={"/tshirts"}><a className="text-gray-600 hover:text-gray-800">First Link</a></Link>
          </li>
          <li>
            <Link href={"/tshirts"}><a className="text-gray-600 hover:text-gray-800">Second Link</a></Link>
          </li>
          <li>
            <Link href={"/tshirts"}><a className="text-gray-600 hover:text-gray-800">Third Link</a></Link>
          </li>
          <li>
            <Link href={"/tshirts"}><a className="text-gray-600 hover:text-gray-800">Fourth Link</a></Link>
          </li>
        </nav>
      </div>
    </div>
